...
At **JapoGo**, we take security seriously and strive to protect our website and users from potential threats. Although our website does not collect personal user data directly, we implement security measures to safeguard our platform.


## 1. Scope

This Security Policy applies to the **JapoGo** website (JapoGo.com), including its infrastructure, content, and third-party services used (such as Google Analytics).
...
- 📩 **Bug Report Form:** JapoGo.com/report 
...
**Thank you for helping JapoGo maintain a safe and secure website! 🚀**  
`;
