...
**JapoGo, topluluk katkıları sayesinde birden çok dilde mevcuttur:**
...
JapoGo, Hiragana, Katakana, Kanji ve kelime bilgisinde ustalaşmayı eğlenceli ve kolay hale getiren etkileşimli bir web tabanlı Japonca öğrenme platformudur. Estetiğe, özelleştirilebilirliğe ve etkili öğrenmeye odaklanılarak tasarlanan JapoGo, her seviyeden Japonca öğrencisi için kapsamlı bir eğitim ortamı sunar.

İster daha yeni kana hecelerini öğrenmeye başlıyor olun, isterseniz de ileri düzey kanji ve kelimeler ile JLPT sınavlarına hazırlanıyor olun, JapoGo akıcı, dikkat dağıtıcı öğelerden uzak sizin tercihlerinize ve öğrenme tarzınıza uyum sağlayan bir öğrenme deneyimi sunar.

### ✨ Öne Çıkan Özellikler

#### 🎯 **Üç Eğitim Dojosu**

- **NihonPath** - Hiragana ve Katakana hece sistemlerinde temel, dakuon, yoon ve yabancı ses gruplarını öğrenerek ustalaşın
...
JapoGo, maksimum esneklikle birleştirilmiş minimalist bir estetiği benimser. Tasarım felsefesinin merkezinde şunlar yer alır:
...
JapoGo, en iyi performans ve geliştirici deneyimi için modern web teknolojileri ile geliştirilmiştir:
...
Katkılarınızı bekliyoruz! JapoGo, topluluk tarafından topluluk için geliştirilen açık kaynaklı bir projedir. Nasıl katkıda bulunacağınıza dair daha ayrıntılı bilgi için [CONTRIBUTING.md](CONTRIBUTING.md) dosyasına göz atın.
...
- JapoGo'yu daha iyi hale getirmek için katkı katkıda bulunanlar

## 📞 İletişim & Bağlantılar

- **Web sitesi**: [JapoGo.com](https://JapoGo.com)
- **Depo**: [github.com/lingdojo/JapoGo](https://github.com/lingdojo/JapoGo)
