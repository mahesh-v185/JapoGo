# This is the basic directories, files and workflow to translate JapoGo using `next-intl` internationalization tool.
...
`{ "MenuInfo": { "greeting": "¡Bienvenido a JapoGo!"...} }`
