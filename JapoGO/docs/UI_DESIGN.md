...
> **Design System Documentation for JapoGo**  
...
JapoGo is built with modern web technologies optimized for performance and developer experience:
...
JapoGo leverages Tailwind CSS as the primary styling solution with a heavy emphasis on **CSS custom properties (CSS variables)** for theming. This approach provides:
...
JapoGo uses a **5-variable color system** defined in `app/globals.css`:
...
JapoGo is gradually adopting [shadcn/ui](https://ui.shadcn.com/) for consistent, accessible components.
