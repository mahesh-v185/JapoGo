...
This guide helps you resolve common issues when setting up and running JapoGo locally.
...
cd ~
git clone https://github.com/<your-username>/JapoGo.git
cd JapoGo
npm install
npm run dev
```
...
1. **Check existing issues:** [GitHub Issues](https://github.com/lingdojo/JapoGo/issues)
2. **Open a new issue:**
